...
//                }
//            }
//            int pertsportsHeard = (sportsHeardNum * 100) / sportsStudents
//                .getLength();
//            int pertsportsLike = (sportsLikeNum * 100) / sportsStudents
//                .getLength();
//
//            int pertreadingHeard = (readingHeardNum * 100) / readingStudents
//                .getLength();
//            int pertreadingLike = (readingLikeNum * 100) / readingStudents
//                .getLength();
//
//            int pertartHeard = (artHeardNum * 100) / artStudents.getLength();
//            int pertartLike = (artLikeNum * 100) / artStudents.getLength();
//
//            int pertmusicHeard = (musicHeardNum * 100) / musicStudents
//                .getLength();
//            int pertmusicLike = (musicLikeNum * 100) / musicStudents
//                .getLength();
//
